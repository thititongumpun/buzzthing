...
// Step 1: Bundle the service worker TS source with esbuild
...
// Step 2: Inject precache manifest using workbox-build
...
console.log(
  `[generate-sw] Done! Precached ${count} files, totalling ${(size / 1024).toFixed(1)} KB`,
)
